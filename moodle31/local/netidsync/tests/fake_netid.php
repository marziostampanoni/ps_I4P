...
class fake_netid {
    ...
    public static function create() {
        return new decorated_fake_netid(new fake_netid());
	}
...
class decorated_fake_netid {
    ...
    public function __construct($real_netid) {
        $this->real_netid = $real_netid;
    ...
    public function __call($method, $args) {
        ...
        return call_user_func_array(array($this->real_netid, $method), $args);
    }
}
