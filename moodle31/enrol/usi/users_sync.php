...
/**
 * This is the file from which the users can select the USI students to enrol in 
...
// set the page URL
$PAGE->set_url('/enrol/usi/users_sync.php', array('id'=>$course->id));
...
// get a form instance
$mform = new \enrol_usi\forms\users_sync_form(NULL, $course, 'post', '', array('id'=>'usi_sync_form'));
...
$PAGE->set_title(get_string('pluginname', 'enrol_usi'));

// define the strings to pass to the YUI module
$PAGE->requires->string_for_js('choosedots', 'moodle'); 
$PAGE->requires->string_for_js('ws_not_available', 'enrol_usi'); 

// include the YUI module
$PAGE->requires->yui_module('moodle-enrol_usi-usiws', 'M.enrol_usi.usiws.init');
