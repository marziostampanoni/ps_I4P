...
class plugin_enrolment_synchronization_completed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('plugin_enrolment_synchronization_completed_event', 'enrol_supsifb');
    }
