...
/**
 * Represents a resource retrieved with the SUPSI Web Service.
 * 
 * A Resource has an identifier and a name which can be respectively
 * accessed with the getter methods 'get_id' and 'get_name'.
 ...
 * parameter.
 *
 * A 'map' representation can be obtained too by using the 'as_map' method.
